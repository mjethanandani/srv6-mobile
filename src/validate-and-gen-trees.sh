...
do
    ...
    response=`yanglint -ii -t config -p ../bin/yang-parameters/ ../bin/yang-parameters/ietf-network-instance@2019-01-21.yang ../bin/imported-modules/ietf-bgp@2022-07-03.yang ../bin/imported-modules/ietf-srv6-base@2022-01-14.yang ../bin/ietf-mup\@$(date +%Y-%m-%d).yang $name.xml`
    if [ $? -ne 0 ]; then
